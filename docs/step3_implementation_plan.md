...
LABEL_MAPPING = {
    0: "Greeting / Conversation Starter (Opening greetings like hello, hi, good morning)",
    1: "Goodbye / Farewell (Ending conversation, parting ways, see you later, bye)",
    2: "Expression of Gratitude (Thank you, thanks for help, appreciation)",
    3: "Agreement / Affirmation (Yes, that's correct, sounds good, agreeing or confirming)",
    4: "Disagreement / Negative Response (No, disagreeing, that's not right, declining)",
    5: "Topic Suggestion / Small Talk (Casual chit-chat, how's your day, weather, casual talk)",
    6: "System Capabilities Inquiry (Asking what the AI/system can do, its features or limits)",
    7: "Praise / Positive Feedback (Complimenting, excellent job, great service, high praise)",
    8: "Complaint / Dissatisfaction (Complaining about poor quality, bugs, slow response, bad experience)",
    9: "Help / Clarification Request (Asking to explain more, clarify, how-to help, repeat)",
    10: "Feature Suggestion / Constructive Feedback (Recommending new features, UI improvements)",
    11: "Language / Settings (Inquiring about or requesting language change, supported languages, settings)",
}
